  ...
  >
    <div className="flex-1 flex flex-row justify-between items-center">
      <img
        ...
        alt={song?.title}
      />
      <div className="flex-1 flex flex-col justify-center mx-3 font-mono">
        <Link to={`/songs/${song.key}`}>
          <p className="mb-1 w-4/5 text-titleBlack font-bold text-lg truncate group-hover:text-activeBlue transition">{song?.title}</p>
        </Link>
    ...
    <div className="text-gray hover:text-textBlack">
      <PlayPause
        isPlaying={isPlaying}
